...
# 10 "Laboratorio4.s" 2
    ...
    MOVLW 100
    MOVWF TMR0
    BCF ((INTCON) and 07Fh), 2; Limpiamos bandera de Timer0
    ENDM

    PSECT udata_bank0; common memory
    ContadorDisplay1: DS 1
    ContadorDisplay2: DS 1
...
; ___________________________ Configuramos el prescaler_______________________
    ...
    CONTADOR_TMR0:
    MOVLW 50
    SUBWF ContadorDisplay1,W
    BTFSC STATUS,2
    CALL AUMENTAR_DISPLAY_TMR0
    RETURN

    AUMENTAR_DISPLAY_TMR0:
    CLRF ContadorDisplay1
    BCF STATUS,2
    INCF ContadorDisplay2
    MOVLW 00001111B
    ANDWF ContadorDisplay2
    MOVF ContadorDisplay2,W
    CALL Tablas
    MOVWF PORTD
    RETURN
