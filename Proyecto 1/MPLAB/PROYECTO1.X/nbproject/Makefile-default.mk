...
SOURCEFILES_QUOTED_IF_SPACED=PROYECTO1.s MACROS_RUTINAS.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/PROYECTO1.o ${OBJECTDIR}/MACROS_RUTINAS.o
POSSIBLE_DEPFILES=${OBJECTDIR}/PROYECTO1.o.d ${OBJECTDIR}/MACROS_RUTINAS.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/PROYECTO1.o ${OBJECTDIR}/MACROS_RUTINAS.o

# Source Files
SOURCEFILES=PROYECTO1.s MACROS_RUTINAS.s
...
${OBJECTDIR}/MACROS_RUTINAS.o: MACROS_RUTINAS.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/MACROS_RUTINAS.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/MACROS_RUTINAS.o \
	MACROS_RUTINAS.s \
	 -msummary=+mem,-psect,-class,-hex,-file,-sha1,-sha256,-xml,-xmlfull -fmax-errors=20 -mwarn=0 -xassembler-with-cpp
