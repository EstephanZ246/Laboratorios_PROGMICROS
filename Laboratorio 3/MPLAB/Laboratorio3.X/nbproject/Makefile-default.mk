...
SOURCEFILES_QUOTED_IF_SPACED=Laboratorio3.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Laboratorio3.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Laboratorio3.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Laboratorio3.o

# Source Files
SOURCEFILES=Laboratorio3.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Laboratorio3.o: Laboratorio3.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Laboratorio3.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/Laboratorio3.o \
	Laboratorio3.s \
...
dist/${CND_CONF}/${IMAGE_TYPE}/Laboratorio3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o dist/${CND_CONF}/${IMAGE_TYPE}/Laboratorio3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
